...
stDate POSYearToDate(short POSDay)
{
    stDate Date;
...
{
    stDate Date = POSYearToDate(POSDay);
    Date.Year = Year;
...
int main()
{
    ...
    cout << "Calculating the days of patience: " << CalculatingTheDaysOfPatience(Year,Month,Day) << endl;

    PrintPOSDateToDate(Year,CalculatingTheDaysOfPatience(Year,Month,Day));
}